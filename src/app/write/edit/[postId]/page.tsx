  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!title || !content || !excerpt) {
        toast("Title, Content & Excerpt are required!", {
          style: {
            color: "white",
            background: "#1e3a8a",
          },
    ...
    <section className="max-w-3xl mx-auto py-20 px-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          className="w-full bg-transparent text-4xl font-bold text-white placholder-gray-500 outline-none mb-6"
        />
        ...
        {/*editor */}
        <div className="rounded-2xl overflow-hidden boder border-white/10">
          <JoditEditor
            ref={editor}
            value={content}
            config={config}
