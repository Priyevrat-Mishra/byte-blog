            ...
            <div className='px-4 sm:px-12'>
                ...
                <div className='space-y-14'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
                        <Image src="/images/about.jpeg" alt='about-image' width={600} height={600} className='rounded-2xl object-cover' />
                        <div>
                            <h2 className='text-2xl font-semibold text-gray-200 mb-4'>
                                Why ByteBlog?
                            </h2>
                            <p className='text-gray-400 leading-relaxed'>
                                ByteBlog was created to share insights on modern technologies
                    ...
                    <div className='text-center'>
                        ...
                        <p className='text-gray-400 max-w-2xl mx-auto leading-relaxed mb-8'>
                            Whether you&apos;re just starting out or refining your skills, ByteBlog
